<template>
  <div>
    ...
    <div class="box">
      <div id="dc-data-count-chart"></div>
      <div id="dc-data-table-chart"></div>
    </div>
    <div class="box">
        <div class="dc-data-count">
            <span class="filter-count"></span> selected out of <span class="total-count"></span> records |
                <a v-on:click="dc.filterAll(), dc.renderAll()">Reset All</a>
        </div>
    </div>
    <div class="box">
...
console.log(d3, crossfilter, dc, colorbrewer)
